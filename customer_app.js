...
const { ValidationError, InvalidUserError, AuthenticationFailed } = require('./errors/CustomError');                   // Node.js path module for working with file and directory paths
...
const uri =  "mongodb://root:NTE3Ny1pb2FuYW1j@localhost:27017";
